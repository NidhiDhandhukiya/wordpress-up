...
<section id="banner-inner">
    <div class="container">
        <div class="our-work-heding-text banner-inner-tetx">
            <h1><?php echo esc_html__('Search results for : ', 'impressive-business') . get_search_query(); ?></h1>
        </div>
        <?php impressive_business_custom_breadcrumbs(); ?>
    </div>
</section>
<section id="banner-section">
    <div class="container">
        <div class="row">
            ...
            <div class="search-text-banner-section">
                <p><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'impressive-business'); ?></p>
               <?php get_search_form(); ?> 
            </div>
            <?php endif; ?>
            </div>
