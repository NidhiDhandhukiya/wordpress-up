...
if ( ! function_exists( 'startkit_info_plu' ) ) :
    ...
    $info_icons4			= get_theme_mod('info_icons4','fa-shield');
	$info_title4			= get_theme_mod('info_title4','Our Security');
	$info_description4      = get_theme_mod('info_description4','The chunk standard of Lorem Ipsum used since the 900s is reproduced below');
?>
<!-- Start: Features List
    ============================= -->
    ...
    <section id="features-list">
        <div class="container">
            <div class="row text-lg-left text-md-center">
                ...
                <div class="col-lg-3 col-md-6 col-12 p-md-0 mt-md-0 mt-4">
                    <div class="featured-box wow fadeInUp third" data-wow-delay="0.1s">
                        <h5 class="title"><i class="fa <?php echo esc_attr( $info_icons3 ); ?>"></i> <?php echo esc_html( $info_title4 ); ?></h5>
                        <p><?php echo wp_kses_post( $info_description4 ); ?></p>
                        <!--a class="view-more" href="#">Read More</a-->
                    </div>
                </div>
            </div>
