           ...
           $paged = isset($attributes['paged']) ? $attributes['paged'] : 1;
            ...
            if( $attributes['postLayout'] === 'slides'){
                ...
                foreach ( $recent_posts as $post ){
                    ...
                    $image = $attributes['post_type'] === 'attachment' ? $post['guid'] : $image_src;
            ...
            if( $attributes['postLayout'] !== 'slides') {
                ...
                $markup_before .= sprintf( '<div class="%1$s %2$s %3$s %4$s" style="--item-padding-left-right : '.$columnGap.'px; --item-minus-padding-left-right : -'.($columnGap).'px; --item-margin-bottom : '.($columnGap*2).'px; --item-height: '.$itemHeight.'; --image-height:'.($imageHeight).';">', esc_attr( $gridViewWrapper ), $attributes['gridLayoutStyle'], $widthClass, $_gpl_row );
...
//            }
         ...
         */
        function gpl_pagination($paged, $paginationStyle, $pages = '') {
