        ...
        for ($i=0; $i < count($form_data[0]); $i++)    
        {
            ...
            else if ($form_data[0][$i]->ftype == 'fapp')    
            {
                for ($j=0; $j < count($form_data[0][$i]->services); $j++)  
                    $form_data[0][$i]->services[$j]->name = __($form_data[0][$i]->services[$j]->name,'appointment-hour-booking'); 
                $form_data[0][$i]->emptySelect= __($form_data[0][$i]->emptySelect,'appointment-hour-booking'); 
            }
        }    
